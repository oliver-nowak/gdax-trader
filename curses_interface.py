...
class cursesDisplay:
    ...
    def update_indicators(self, indicators):
        if not self.enable:
            return
        self.stdscr.addstr(1, 0, "5 - OBV: %f OBV_EMA: %f ADX: %f BBAND_HIGH: %f BBAND_LOW: %f" %
                           (indicators['5']['obv'], indicators['5']['obv_ema'], indicators['5']['adx'],
                            indicators['5']['bband_upper'], indicators['5']['bband_lower']))
        self.stdscr.refresh()
